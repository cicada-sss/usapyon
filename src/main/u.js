...
var creimg;
var ach1 = 0;
usaran.push("../images/usa (1).png", "../images/usa (2).png", "../images/usa (3).png", "../images/usa (4).png", "../images/usa (5).png", "../images/usa (6).png", "../images/usa (7).png");
...
setInterval(function() {
    ...
    if (usagi >= 10000 && jupiter == 0) {
        ...
        b.setAttribute("src", "../images/Credit.png");
        ...
        $('#sound1').get(0).play();
        creimg.setAttribute("src", "../images/tairyou.png");
...
function usafuya() {
    ...
    switch (ran) {
        case 0:
            usasrc = "../images/risu.png"
            risu++;
            break;
        case 1:
            usasrc = "../images/kuma.png";
            kuma++;
            break;
        default:
